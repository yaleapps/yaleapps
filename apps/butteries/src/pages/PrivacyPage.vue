<template>
  ...
  <p>
    DCommune built the Yale Buttery Book app as a Free app. This SERVICE is
    provided by DCommune at no cost and is intended for use as is.
  </p>
  <p>
  ...
  <p>
    ...
    and Conditions, which is accessible at Yale Buttery Book unless otherwise
  ...
  <p>
    ...
    not limited to Product Interaction (Anonymous). The information that we
  ...
  <p>This policy is effective as of 2021-11-15</p>
  <p><strong>Contact Us</strong></p>
  <p>
    If you have any questions or suggestions about our Privacy Policy, do not
    hesitate to contact us at yalebutterybook@gmail.com.
  </p>
  <p>
