		...
		<q-card flat class="max-width-card q-mx-auto">
			<q-card-section>
				...
				<template v-if="!showResults">
					...
					<div class="row q-col-gutter-md">
						<div class="col-12 col-sm-8">
							<q-input v-model="email" filled label="Yale Email" :rules="[(val) => isValidEmail(val) || 'Please enter a valid Yale email']"
					...
					<div v-if="hasSubmitted && !submissionData && !isLoading" class="text-negative q-mt-md">
						You have not submitted the form yet. Please submit the form first to see the results.
					</div>
				</template>
				...
				<template v-else>
					...
					<iframe class="tw:w-full tw:h-[400px] tw:mb-8" seamless frameborder="0" scrolling="no"
						src="https://docs.google.com/spreadsheets/d/e/2PACX-1vTJxsgQFo3drZ6W1OY5DIJrET2QYW1HjEl0Rr-Kav5gTl7N9y0jQ6l0Z2IJvgpLA6Vt7Mb0BfQIwSnM/pubchart?oid=1234567890&amp;format=interactive">
					</iframe>

					<div class="text-h5 q-mb-md">Guttiest Courses</div>
					<iframe class="tw:w-full tw:h-[400px] tw:mb-8" seamless frameborder="0" scrolling="no"
						src="https://docs.google.com/spreadsheets/d/e/2PACX-1vTJxsgQFo3drZ6W1OY5DIJrET2QYW1HjEl0Rr-Kav5gTl7N9y0jQ6l0Z2IJvgpLA6Vt7Mb0BfQIwSnM/pubchart?oid=987654321&amp;format=interactive">
					</iframe>

					<div class="text-h5 q-mb-md">Most Popular Majors</div>
					<iframe class="tw:w-full tw:h-[400px]" seamless frameborder="0" scrolling="no"
						src="https://docs.google.com/spreadsheets/d/e/2PACX-1vTJxsgQFo3drZ6W1OY5DIJrET2QYW1HjEl0Rr-Kav5gTl7N9y0jQ6l0Z2IJvgpLA6Vt7Mb0BfQIwSnM/pubchart?oid=456789123&amp;format=interactive">
					</iframe>
				</template>
			</q-card-section>
		</q-card>
